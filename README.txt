...
4 Quick setup
    4.1 Jenkins
        4.1.1 Run Vagrant VM
        4.1.2 Get access to OSSL main console VM
        4.1.3 Initial setup for VM ossl-console
        4.1.4 Setup jenkins on VM ossl-console
        4.1.5 Get access to Jenkins installed on ossl-console VM
5 Main details related with project.
    5.1 Internal network configuration
    5.2 Access over SSH to OSSL vagrant VMs
    5.3 Access to root account.
6 Summary
